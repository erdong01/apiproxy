...
type AiTask struct {
	...
	Model                 string         `gorm:"column:model;" json:"Model"`                                  //type:string           comment:模型                                                                      version:2026-0                                  version:2026-02-21 12:58
	...
	Seed                  *int64         `gorm:"column:seed" json:"seed"`                                     //type:int              comment:本次请求使用的种子整数值。                                                version:2026-02-21 12:58
	...
	Duration              *int64         `gorm:"column:duration" json:"duration"`                             //type:int              comment:生成视频的时长，单位：秒。                                                version:2026-02-21 12:58
	Frames                *int64         `gorm:"column:frames" json:"frames"`                                 //type:int              comment:生成视频的帧数。                                                          version:2026-02-21 12:58
	FramesPerSecond       *int64         `gorm:"column:frames_per_second" json:"framesPerSecond"`             //type:int              comment:生成视频的帧率。                                                          version:2026-02-21 12:58
	...
	ExecutionExpiresAfter *int64         `gorm:"column:execution_expires_after" json:"executionExpiresAfter"` //type:int              comment:任务超时阈值，单位：秒。                                                  version:2026-02-21 12:58
	...
	ErrorCode             string         `gorm:"column:error_code;" json:"errorCode"`                         //type:string           comment:错误码                                                                    version:2026-02-21 14:23
	...
	VendorAmount          float64        `gorm:"column:vendor_amount;" json:"vendorAmount"`                   //type:float64          comment:成本                                                                      version:2026-02-21 14:51
	RetailAmount          float64        `gorm:"column:retail_amount;" json:"retailAmount"`                   //type:float64          comment:零售                                                                      version:2026-02-21 14:51
